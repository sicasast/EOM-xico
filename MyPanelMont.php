  ...
  <div class="row container-fluid">
    <div class="row container-fluid">
      <div class="col-2">
        ...
        <img class="card-img-top" src="ArchivosEOMont/banners/banner1.jpg" alt="Card image cap">
        <div class="card-body">
       ...
       <div class="col-2">
          <div class="card" style="width: 15rem;">
        <img class="card-img-top" src="ArchivosEOMont/banners/banner2.jpg" alt="Card image cap">
        <div class="card-body">
       ...
       <div class="col-2">
<div class="card" style="width: 15rem;">
        <img class="card-img-top" src="ArchivosEOMont/banners/banner3.jpg" alt="Card image cap">
        <div class="card-body">
       ...
       <div class="col-2">
<div class="card" style="width: 15rem;">
<img class="card-img-top" src="ArchivosEOMont/banners/banner4.jpg" alt="Card image cap">
        <div class="card-body">
       ...
       <div class="col-2">
<div class="card" style="width: 15rem;">
<img class="card-img-top" src="ArchivosEOMont/banners/banner5.jpg" alt="Card image cap">
        <div class="card-body">
       ...
       <div class="col-2">
<div class="card" style="width: 15rem;">
<img class="card-img-top" src="ArchivosEOMont/banners/banner6.jpg" alt="Card image cap">
        <div class="card-body">
...
-->
    ...
    <div class="col-4 ">
      ...
      <div class="card" style="width: 23rem; height: 15rem;">
        <img class="card-img-top" src="ArchivosEOMont/noticiap/noticiap.jpg" alt="Noticia Principal">
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <img src="ArchivosEOMont/banners/banner1.jpg" alt="Banner1" class="img-thumbnail">
      <form action="ArchivosEOMont/Banner.php" method="POST" enctype="multipart/form-data">
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
    <img src="ArchivosEOMont/banners/banner2.jpg" alt="Banner2" class="img-thumbnail">
      <form action="ArchivosEOMont/Banner.php" method="POST" enctype="multipart/form-data">
      <p class="card-text"><small class="text-muted">Selecciona el nuevo Banner a cargar</small></p>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
    <img src="ArchivosEOMont/banners/banner3.jpg" alt="Banner3" class="img-thumbnail">
      <form action="ArchivosEOMont/Banner.php" method="POST" enctype="multipart/form-data">
      <p class="card-text"><small class="text-muted">Selecciona el nuevo Banner a cargar</small></p>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
    <img src="ArchivosEOMont/banners/banner4.jpg" alt="Banner4" class="img-thumbnail">
      <form action="ArchivosEOMont/Banner.php" method="POST" enctype="multipart/form-data">
      <p class="card-text"><small class="text-muted">Selecciona el nuevo Banner a cargar</small></p>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
    <img src="ArchivosEOMont/banners/banner5.jpg" alt="Banner5" class="img-thumbnail">
      <form action="ArchivosEOMont/Banner.php" method="POST" enctype="multipart/form-data">
      <p class="card-text"><small class="text-muted">Selecciona el nuevo Banner a cargar</small></p>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
    <img src="ArchivosEOMont/banners/banner6.jpg" alt="Banner6" class="img-thumbnail">
      <form action="ArchivosEOMont/Banner.php" method="POST" enctype="multipart/form-data">
      <p class="card-text"><small class="text-muted">Selecciona el nuevo Banner a cargar</small></p>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
    <img src="ArchivosEOMont/noticiap/noticiap.jpg" alt="NoticiaPrincipal" class="img-thumbnail">
      <form action="ArchivosEOMont/NoticiaPrincipal.php" method="POST" enctype="multipart/form-data">
